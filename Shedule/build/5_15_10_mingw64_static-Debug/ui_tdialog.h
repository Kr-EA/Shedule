...
public:
    ...
    void setupUi(QDialog *tDialog)
    {
        ...
        teacherNameLabel = new QLabel(tDialog);
        teacherNameLabel->setObjectName(QString::fromUtf8("teacherNameLabel"));

        horizontalLayout_2->addWidget(teacherNameLabel);

        teacherNameEdit = new QLineEdit(tDialog);
    ...
    void retranslateUi(QDialog *tDialog)
    {
        ...
        teacherNameLabel->setText(QCoreApplication::translate("tDialog", "\320\230\320\274\321\217 \320\277\321\200\320\265\320\277\320\276\320\264\320\260\320\262\320\260\321\202\320\265\320\273\321\217:", nullptr));
